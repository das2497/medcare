                        ...
                        <div class="col-12 col-lg-4  text-center text-lg-start mt-3">
                            <div class="row align-content-center ">
                                ...
                                <div class="col-12 col-lg-11 ">
                                    <h4 class=" mt-2 mt-lg-3 ms-lg-4 text-white">NURSE <?= $_SESSION["NR"]["name"]; ?></h4>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="container-fluid ">
                                    ...
                                    <div class="collapse navbar-collapse " id="navbarSupportedContent">
                                        <ul class="navbar-nav mb-2 mb-lg-0 text-end  ">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link fw-bold text-white" onclick="nurse_logout();" href="#" tabindex="-1" aria-disabled="true">log out</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
